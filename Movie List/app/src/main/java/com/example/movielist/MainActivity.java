...
public class MainActivity<RequestQueue> extends AppCompatActivity {
    ...
    private List<com.codingstuff.movielist.Movie> movieList;
    @Override
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0 ; i < response.length() ; i ++){
                            ...
                            com.codingstuff.movielist.MovieAdapter adapter = new com.codingstuff.movielist.MovieAdapter(MainActivity.this , movieList);
